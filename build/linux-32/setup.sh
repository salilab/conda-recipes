...
wget https://repo.continuum.io/miniconda/Miniconda3-4.5.11-Linux-x86.sh && echo "5dca8f7aaeeab9506f801c7c8b561a1e7e00aadc3a21008f3c72f82766f6fec6  Miniconda3-4.5.11-Linux-x86.sh" | sha256sum -c --status || exit 1
mock -r $CONFIG --copyin Miniconda3-4.5.11-Linux-x86.sh / || exit 1
mock -r $CONFIG --chroot "bash /Miniconda3-4.5.11-Linux-x86.sh -b -p /root/miniconda && rm -f /Miniconda3-4.5.11-Linux-x86.sh" || exit 1
rm -f Miniconda3-4.5.11-Linux-x86.sh
