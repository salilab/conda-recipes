...
wget https://repo.continuum.io/miniconda/Miniconda3-4.3.27.1-Linux-x86.sh && echo "15fb3364174544d16f452f50eedc32a8a90e27d2fccddff7313654259322105b  Miniconda3-4.3.27.1-Linux-x86.sh" | sha256sum -c --status || exit 1
mock -r $CONFIG --copyin Miniconda3-4.3.27.1-Linux-x86.sh / || exit 1
mock -r $CONFIG --chroot "bash /Miniconda3-4.3.27.1-Linux-x86.sh -b -p /root/miniconda && rm -f /Miniconda3-4.3.27.1-Linux-x86.sh" || exit 1
rm -f Miniconda3-4.3.27.1-Linux-x86.sh
